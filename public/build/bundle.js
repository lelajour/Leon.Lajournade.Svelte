...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			img = element("img");
    			attr_dev(img, "class", "resize svelte-1klrugc");
    			if (img.src !== (img_src_value = "img/lelajour.jpg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Me");
    			attr_dev(img, "align", "center");
    			add_location(img, file$2, 9, 3, 161);
    			attr_dev(div0, "class", "pdp svelte-1klrugc");
    			add_location(div0, file$2, 8, 2, 140);
    			attr_dev(div1, "class", "hex svelte-1klrugc");
    			set_style(div1, "color", "rgba(255, 152, 0, 0.6)");
    			add_location(div1, file$2, 7, 1, 82);
    			attr_dev(div2, "class", "container svelte-1klrugc");
    			add_location(div2, file$2, 6, 0, 57);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/right_column.svelte generated by Svelte v3.20.1 */

    const file$3 = "src/right_column.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "rightcolumn svelte-1pi6dh3");
    ...
    function instance$3($$self, $$props) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Right_column> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("Right_column", $$slots, []);
    	return [];
    }

    class Right_column extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    const file$4 = "src/Background.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(script0, file$4, 9, 1, 134);
    			...
    			add_location(script1, file$4, 10, 1, 209);
    			attr_dev(div, "id", "particles-js");
    			attr_dev(div, "class", "svelte-emygxe");
    			add_location(div, file$4, 7, 0, 101);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Pdp, Rcolumn: Right_column });
    	return [];
    }
